...
default_constants = ConstantDict({
    'stefan_boltzmann_constant': get_backend().get_container_type()(5.670367e-8, attrs={'units': 'W m^-2 K^-4'}),
    'gravitational_acceleration': get_backend().get_container_type()(9.80665, attrs={'units': 'm s^-2'}),
    'heat_capacity_of_dry_air_at_constant_pressure': get_backend().get_container_type()(1004.64, attrs={'units': 'J kg^-1 K^-1'}),
    'heat_capacity_of_water_vapor_at_constant_pressure': get_backend().get_container_type()(1846.0, attrs={'units': 'J kg^-1 K^-1'}),
    'specific_enthalpy_of_water_vapor': get_backend().get_container_type()(2500.0, attrs={'units': 'J kg^-1'}),
    'heat_capacity_of_liquid_water': get_backend().get_container_type()(4185.5, attrs={'units': 'J kg^-1 K^-1'}),
    'freezing_temperature_of_liquid_water': get_backend().get_container_type()(273.0, attrs={'units': 'K'}),
    'thermal_conductivity_of_liquid_water': get_backend().get_container_type()(0.57, attrs={'units': 'W m^-1 K^-1'}),
    'heat_capacity_of_solid_water_as_ice': get_backend().get_container_type()(2108., attrs={'units': 'J kg^-1 K^-1'}),
    'thermal_conductivity_of_solid_water_as_ice': get_backend().get_container_type()(2.22, attrs={'units': 'W m^-1 K^-1'}),
    'heat_capacity_of_solid_water_as_snow': get_backend().get_container_type()(2108., attrs={'units': 'J kg^-1 K^-1'}),
    'thermal_conductivity_of_solid_water_as_snow': get_backend().get_container_type()(0.2, attrs={'units': 'W m^-1 K^-1'}),
    'reference_air_pressure': get_backend().get_container_type()(1.0132e5, attrs={'units': 'Pa'}),
    'reference_air_temperature': get_backend().get_container_type()(300., attrs={'units': 'degK'}),
    'thermal_conductivity_of_dry_air': get_backend().get_container_type()(0.026, attrs={'units': 'W m^-1 K^-1'}),
    'gas_constant_of_dry_air': get_backend().get_container_type()(287., attrs={'units': 'J kg^-1 K^-1'}),
    'gas_constant_of_water_vapor': get_backend().get_container_type()(461.5, attrs={'units': 'J kg^-1 K^-1'}),
    'planetary_rotation_rate': get_backend().get_container_type()(7.292e-5, attrs={'units': 's^-1'}),
    'planetary_radius': get_backend().get_container_type()(6.371e6, attrs={'units': 'm'}),
    'latent_heat_of_vaporization_of_water': get_backend().get_container_type()(2.5e6, attrs={'units': 'J kg^-1'}),
    'latent_heat_of_fusion_of_water': get_backend().get_container_type()(333550.0, attrs={'units': 'J kg^-1'}),
    'density_of_liquid_water': get_backend().get_container_type()(1e3, attrs={'units': 'kg m^-3'}),
    'density_of_solid_water_as_ice': get_backend().get_container_type()(916.7, attrs={'units': 'kg m^-3'}),
    'density_of_solid_water_as_snow': get_backend().get_container_type()(100.0, attrs={'units': 'kg m^-3'}),
    'solar_constant': get_backend().get_container_type()(1367., attrs={'units': 'W m^-2'}),
    'planck_constant': get_backend().get_container_type()(6.62607004e-34, attrs={'units': 'J s'}),
    'speed_of_light': get_backend().get_container_type()(299792458., attrs={'units': 'm s^-1'}),
    'seconds_per_day': get_backend().get_container_type()(86400., attrs={'units': 'dimensionless'}),
    'avogadro_constant': get_backend().get_container_type()(6.022140857e23, attrs={'units': 'mole^-1'}),
    'boltzmann_constant': get_backend().get_container_type()(1.38064852e-23, attrs={'units': 'J K^-1'}),
    'loschmidt_constant': get_backend().get_container_type()(2.6516467e25, attrs={'units': 'm^-3'}),
    'universal_gas_constant': get_backend().get_container_type()(8.3144598, attrs={'units': 'J mole^-1 K^-1'}),
})
...
def set_constant(name, value, units):
    ...
    if is_valid_unit(units):
        constants[get_alias(name)] = get_backend().get_container_type()(value, attrs={'units': units})
    else:
